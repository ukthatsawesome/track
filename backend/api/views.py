...
class IsAdminOrNotCompleted(BasePermission):
    """Custom permission to allow only admins to edit completed objects."""
    ...
    def has_object_permission(self, request, view, obj):
        ...
        # For other methods (PUT, PATCH, DELETE), only allow if status is not 'finished'
...
class BatchViewSet(viewsets.ModelViewSet):
    ...
    def perform_create(self, serializer):
        # Generate the batch identifier before saving
        # This assumes batch_id is already available after the first save
        # or that the serializer handles the initial save to get an ID.
        # For now, we'll assume the batch_id is generated by the DB.
        # The actual batch field will be set after the instance is created.
